                ...
                <Hidden smUp>
                    <div className="d-flex flex-fill flex-row">
                        <div className="d-flex 100vh flex-column w-100">
                            <div
                                className="d-flex flex-fill flex-column align-items-center justify-content-end mobile-banner-height">
                                <PerfectScrollbar className="d-flex w-100 h-100 flex-column justify-content-end align-items-center">
                                    <BackgroundVideo
