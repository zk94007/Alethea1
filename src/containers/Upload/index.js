          ...
          <div className="row p-0 m-0">
            <div className="col-md-3 vh-100 p-0 splitter">
              <PerfectScrollbar className="d-flex flex-column">
                ...
                <h5 className="gray-color mx-5 mb-4">
                  Upload an image to let us know what your virtual influencer
                  should look like. Please follow the guidelines to ensure the
                  best results.
                </h5>
                <Button
                  variant="contained"
            ...
            <Hidden xsDown>
              <div className="d-flex col-md-9 vh-max-100 upload-background overflow-hidden flex-column pt-3 px-4 pb-4">
                <h1 className="font-weight-semi-bold mx-2 mb-4 mt-5">
                  Upload Image
                </h1>
                <Dropzone>
                  {({ getRootProps, getInputProps }) => (
                    <section className="flex-fill image-dropzone d-flex m-2">
                      ...
                      >
                        <input {...getInputProps()} />
                        <ReactSVG
                          src={require("../../assets/drag_and_drop.svg")}
                        />
                        <h5 className="mt-3 ">
