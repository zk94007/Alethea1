        ...
        return (
            <div className="d-flex vh-100 flex-column justify-content-center align-items-center">
                <div className="d-flex flex-column">
                    ...
                    <TextField
                        id="email" variant="outlined" className="mx-xl-5 mx-lg-4 mx-md-3 mx-sm-5 mb-3 mx-3"
                        value={username}
                        onChange={(e) => this.setState({username: e.target.value})}
                        placeholder="Please enter your Email address"
                    />
                    {this.validator.message('email', username, 'required|email', { className: 'text-danger' })}
                </div>
                <div className="d-flex flex-column">
                    <label className="mx-xl-5 mx-lg-4 mx-md-3 mx-sm-5 mx-3 font-weight-medium">
                        Password
