...
import {selectVideoId} from "../redux/actions";
                        ...
                        <div className="col-md-3 vh-100 p-0 splitter d-flex">
                            <div className="d-flex flex-column flex-fill align-items-center">
                                ...
                                <div className="w-100 px-xl-5 px-lg-4 px-md-3 px-sm-5 d-flex flex-fill align-items-end">
                                    <Button variant="contained" color="primary" disabled={selectedIndex === null}
                                            className="mb-5 w-100" onClick={() => this.onContinue()}>
                                        Select and continue
                                    </Button>
                                </div>
                            </div>
                    ...
                    <div className="d-flex flex-fill flex-row">
                        <div className="d-flex vh-100 flex-column w-100">
                            ...
                            <div className="d-flex flex-column bottom-stepper">
                                <Button variant="contained" disabled={selectedIndex === null} color="primary"
                                        className="m-3" onClick={() => this.onContinue()}>
                                    Select and continue
                                </Button>
                                <MobileStepper
                                    variant="dots"
...
const mapStateToProps = (state) => ({
    profile: state.alethea.videoKey ?? {}
});
