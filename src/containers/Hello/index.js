                    ...
                    <PerfectScrollbar className="flex-fill">
                        <div className="d-flex row p-0 m-0 w-100">
                            <Hidden xsDown={showContent}>
                                <div
                                    className="col-12 col-md-3 flex-fill p-0 splitter vh-100 justify-content-between d-flex flex-column">
                                    <Hidden xsDown>
                            ...
                            <Hidden xsDown={!showContent}>
                                <div
                                    className="d-flex col-12 col-md-9 vh-max-100 overflow-hidden p-0 p-sm-4 d-flex flex-column">
                                    <PerfectScrollbar>
                                        <h1 className="font-weight-semi-bold mb-2 mb-md-4 mt-4 mt-md-2 text-center text-md-left">TikTok</h1>
                                        <Hidden smUp>
                                            <h5 className="gray-color text-center mb-4 pb-2">Recreate trending TikTok
                                                videos,<br/>featuring your favorite stars.</h5>
                                        </Hidden>
                                        {this.renderContent()}
                                    </PerfectScrollbar>
                                </div>
