...
import FinalItem from "../../compnents/FinalItem";
                    ...
                    <PerfectScrollbar className="flex-fill">
                        <div className="d-flex row p-0 m-0 w-100">
                            <Hidden xsDown={showContent}>
                                <div className="col-12 col-md-3 flex-fill p-0 splitter vh-100 justify-content-between d-flex flex-column">
                                    <Hidden xsDown>
                                        <ReactSVG src="logo_white.svg" className="logo-max-width p-0 m-3 mx-xl-5 mx-lg-4 mx-md-3 mx-sm-5 mb-5" />
                                    </Hidden>
                                    ...
                                    <div className="mt-auto">
                                        <div className="d-flex w-100 mt-auto">
                                            <Button variant="contained" color="primary" className="mx-xl-5 mx-lg-4 mx-md-3 mx-sm-5 mx-3 flex-fill" onClick={() => this.setState({showContent: true})}>
                                                TikTok
                                            </Button>
                                        </div>
                            ...
                            <Hidden xsDown={!showContent}>
                                <div className="d-flex col-12 col-md-9 vh-max-100 overflow-hidden p-0 p-sm-4 d-flex flex-column">
                                    <PerfectScrollbar>
                                        <h1 className="font-weight-semi-bold mb-2 mb-md-4 mt-4 mt-md-2 text-center text-md-left">TikTok</h1>
                                        <Hidden smUp>
                                            <h5 className="gray-color text-center mb-4 pb-2">Recreate trending TikTok videos,<br/>featuring your favorite stars.</h5>
                                        </Hidden>
                                        {this.renderContent()}
                                    </PerfectScrollbar>
                                </div>
