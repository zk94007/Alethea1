...
import { requestGetResult, requestGetStatus, requestText2Speech } from "../redux/actions";
...
class Generating extends Component {
    ...
    textInput = (e) => {
        this.setState({ message: e.target.value, curRemainingLen: 20 - e.target.value.length })
    };
    renderContent() {
        ...
        return (
            <div className="d-flex flex-column flex-fill">
                ...
                <TextField id="name-input" variant="outlined" className="mx-xl-5 mx-lg-4 mx-md-3 mx-sm-5 mb-3 mx-3"
                    value={name}
                    disabled={isWaiting}
                ...
                />
                <label className="mx-xl-5 mx-lg-4 mx-md-3 mx-sm-5 mx-3 text-right font-weight-small" >{curRemainingLen} characters remained</label>
            </div>
        );
    }
