      ...
      <div className="item-container">
        <div
          className={
            ...
            (isActive ? "active-item-header" : "item-header")
          }
        >
          <label className="avatar-sticker">Genesis</label>
          <label className="font-weight-bold flex-fill text-center my-2 pr-5">
            {name}
          </label>
        </div>
        <div className="inventory-container">
          <img src={src} alt={name} className="item-image h-100 object-fit" />
